...
exports.DoctorWork = index_1.sequelize.define('DoctorWork', {
    // 属性
    wokrId: {
...
exports.createTableDoctorWork = function () {
    exports.DoctorWork.sync({ force: true }).then(function () {
        console.log('创建成功');
    });
};
exports.insert = function (doctorWorkInfo) {
    return exports.DoctorWork.create(doctorWorkInfo).then(function (res) {
        console.log(res.id);
        return true;
    }).catch(function (e) {
        console.log(e);
...
exports.findOneByKey = function (key, value, attributes) {
    var params = {};
    params[key] = value;
    return exports.DoctorWork.findOne({
...
exports.findAllByKey = function (params) {
    return exports.DoctorWork.findAll({
        where: __assign({}, params),
    }).then(function (info) {
...
exports.update = function (updateParams, selectParams) {
    ...
    return exports.DoctorWork.update(updateParams, {
