...
var doctorWork_1 = require("../../models/doctorWork");
...
exports.createWorkList = function (ctx, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        ...
        getScheduleDateList().forEach(function (date) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, doctorWork_1.findOneByKey('data', date + "T00:00:00.000Z", ['wokrId'])];
                    case 1:
                        DoctorWork = _a.sent();
                        if (DoctorWork) {
                        }
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, doctorWork_1.findOneByKey('wokrId', params.wokrId, ['wokrId', 'doctors'])];
            case 1:
                findResult = _a.sent();
                if (!findResult) {
                ...
                midArray = findResult.doctors.split(',');
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                newDoctors = findResult.doctors === null || findResult.doctors === '' ?
        ...
        switch (_a.label) {
            case 0:
                ...
                listPromise = getScheduleDateList().map(function (date) { return __awaiter(void 0, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, doctorWork_1.findAllByKey({
